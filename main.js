...
function kep(event) {
    ...
    if (event.key == "s") {
        ...
        fetch('http://192.168.1.21/rmotoronb');
        fetch('http://192.168.1.21/lmotoronb');
    ...
    if (event.key == "w") {
        ...
        fetch('http://192.168.1.21/rmotoronf');
        fetch('http://192.168.1.21/lmotoronf');
...
function keyuppp(event) {
    ...
    if (event.key == "w") {
        fetch('http://192.168.1.21/rmotoroff');
        fetch('http://192.168.1.21/lmotoroff');
    }
    if (event.key == "a") {
        fetch('http://192.168.1.21/rmotoroff');
        fetch('http://192.168.1.21/lmotoroff');    }
